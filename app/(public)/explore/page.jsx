...
const ExplorePage = () => {
  ...
  const { data: localEvents, isLoading: loadingLocal } = useConvexQuery(
    ...
    {
      city: currentUser?.location?.city || "Chennai",
      state: currentUser?.location?.state || "Tamil Nadu",
      limit: 4,
    }
  );
  ...
  const handleViewLocalEvents = () => {
    const city = currentUser?.location?.city || "Chennai";
    const state = currentUser?.location.state || "Tamil Nadu";
  ...
  return (
    <>
      ...
      {popularEvents && popularEvents.length > 0 && (
        <div className="mb-16">
          <div className="mb-6">
            <h2 className="text-3xl font-bold mb-1">Popluar Across India</h2>
